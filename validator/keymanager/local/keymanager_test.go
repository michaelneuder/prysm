...
func TestLocalKeymanager_MnemnonicPassphrase_DifferentResults(t *testing.T) {
	ctx := context.Background()
	wallet := &mock.Wallet{
		Files:            make(map[string]map[string][]byte),
		AccountPasswords: make(map[string]string),
...
func TestLocalKeymanager_RecoverSeedRoundTrip(t *testing.T) {
...
func TestLocalKeymanager_FetchValidatingPublicKeys_FromMnemonic(t *testing.T) {
...
func TestLocalKeymanager_FetchValidatingPrivateKeys_FromMnemonic(t *testing.T) {
	derivedSeed, err := seedFromMnemonic(constant.TestMnemonic, "")
	require.NoError(t, err)
	wallet := &mock.Wallet{
		Files:            make(map[string]map[string][]byte),
...
func TestLocalKeymanager_Sign_FromMnemonic(t *testing.T) {
	wallet := &mock.Wallet{
		Files:            make(map[string]map[string][]byte),
		AccountPasswords: make(map[string]string),
		WalletPassword:   password,
